  ...
  def pomocnicza(
    ...
    if (licznik == 0) {
      if (lista1.isEmpty && lista2.isEmpty) wynik
        ...
        pomocnicza(lista1.tail, lista2, wynik :+ lista1.head, lista1.head, licznik + 1)
      else if (lista1.isEmpty && lista2.nonEmpty)
        pomocnicza(lista1, lista2.tail, wynik :+ lista2.head, lista2.head, licznik + 1)
